...
def Build_RC_Column(Diameter,Height_of_Column, fPrimeC,dbi, dti, CL, dblc, nb, s_tc, datadir, AxialLoad, GM_file, GM_dt, GM_npt):
    # -----------------------------------------------------------------------------
    #
    #    ^Y
    #    |
    ...
    Fy = 60.0 * ksi * (1 - 0.021 * CL)  # STEEL yield stress
