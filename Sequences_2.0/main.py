...
GeomDB = pd.read_csv(r'C:\ConditionDependentPBEE\NLTHA_ConditionDependentPBEE\Sequences_2.0\column_database.csv')
# ----------------------------------------------------------------------------
#|                             BATCH RUN
# ----------------------------------------------------------------------------
...
for column,Crow in GeomDB.iterrows():
    ...
    for shapefactor in iShapeFactor:
        ...
        for ALR in iALR:
            ...
            Ag=0.25*math.pi*D**2
            AxialLoad=compressive_strength_concrete*Ag
            ...
            #                print('CLt   = ',CLt)
                            ...
                            Build_RC_Column(Diameter,Height_of_Column, fPrimeC,dbi, dti, CLl, dblc, nb,cover, Ablc, CLt, Atc, dbtc, s_tc, datadir, AxialLoad, GM_file, GM_dt, GM_npt)
