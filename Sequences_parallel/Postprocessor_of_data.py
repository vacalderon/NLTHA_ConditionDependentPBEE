...
def Postprocessor_of_data(GM_fn, cover, wcr, Time,D,SF,ALR,rhol,rhov):
    ...
    SpectrumDir='C:\ConditionDependentPBEE\GroundmotionSelection\Response Spectrum Analysis'
    rootdir = r'C:\ConditionDependentPBEE\NLTHA_ConditionDependentPBEE\Sequences_2.0\data'
    ...
    # 12. Writing CSV File
    DataFrame_Out.to_csv(r'.\results\PosprocData.csv', mode='a', header=False)
