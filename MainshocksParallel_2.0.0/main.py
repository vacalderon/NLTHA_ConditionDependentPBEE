...
pid = ops.getPID()
np = ops.getNP()
GM_Path = r'/share/kowalsky/vacalder/MainshocksParallel_1.2.1/GroundMotion_Mainshock_Records'
GMListing = os.listdir(GM_Path)
rootdir = r'/share/kowalsky/vacalder/MainshocksParallel_1.2.1'
                ...
                for CL in iCL:
                    for CLt in iCLt:
                        if (counter % np) == pid:
                            ...
                            Postprocessor_of_data.Postprocessor_of_data(GM_fn, CL, CLt, D, shapefactor, ALR, rhol, rhov)
