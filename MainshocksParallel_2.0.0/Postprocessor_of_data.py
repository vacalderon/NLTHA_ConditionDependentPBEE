...
def Postprocessor_of_data(GM_fn, CL, CLt, D, SF, ALR, rhol, rhov):
    ...
    SpectrumDir = r'/share/kowalsky/vacalder/MainshocksParallel_1.2.1/ResponseSpectrumAnalysis'
    rootdir = r'/share/kowalsky/vacalder/MainshocksParallel_1.2.1/data'
    ...
    AxialLoadRatio = float(lines_material_prop.split()[15])
    dbl = float(lines_material_prop.split()[16])
...
# 11. Writing data to variables 
    ...
    # 12. Writing CSV File
    DataFrame_Out.to_csv('/share/kowalsky/vacalder/MainshocksParallel_1.2.1/results/PosprocData.csv', mode='a',
                         header=False)
